...
To get things moving quickly, we have "pre-loaded" a set of topics and question prompts. If there is something you would like to discuss that's not already listed, please add it to the list!
...
> [!TIP] Reminder
> 1 `x` = 1 in-person attendee.
> 1 `o` = 1 online attendee.
> Please only vote once.


#### Defining and communicating the role of an RSE

- How can we effectively articulate the value-addition of an RSE?
- How can we make sure we are called upon at the right time (i.e. avoid being seen as a last-resort to be brought in to fix a fully generated codebase)
- What is different about AI for _research_ software, compared with general software?


==Vote here:==

#### Sharing tips - good/bad uses of AI in RSE

- Not just code generation: testing, readability, documentation, ...
- What works? What wastes time? How to be productive and avoid the failure mode where you hack prompts to get it to do something you could do faster?
- AI versus traditional tools: Where do AI tools substantually augment your toolkit, and where are the gains marginal or nonexistent compared with traditional tools?
- What, if anything, are 'agentic' models good for in RSE?
- What is different about AI for _research_ software, compared with general software?

==Vote here:==

#### Fixing gaps in knowledge, skills and support structures

- What kinds of resources, training and follow-up activities would be most valuable at this time?
- How is the impact of AI felt differently among RSEs (of e.g. different specialisms, career stages, organisation types, remote/in-person working...), and what support structures can we create together to mitigate any negative differential impacts.

==Vote here:==

#### Cultural norms in RSE
...
- What criteria might RSEs use to evaluate their use of AI tools?
- What concrete steps can green-minded RSEs take to reduce their environmental footprint (specifically related to use of AI tools)?
- What evidence should we be looking out for, or contributing to the production of, to inform our practice?

> [!TIP]
> The [GREENER principles](https://socrse.github.io/green-sig/GREENER.html) might be a helpful scaffold for this discussion.
...
> [!NOTE]
> If you are keen to be directly involved in the writing but cannot make the afternoon session, please speak to one of the organisers!
